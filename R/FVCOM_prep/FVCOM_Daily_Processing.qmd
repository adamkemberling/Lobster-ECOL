...
```{r}
#| label: processing-one-month-temps
#| eval: false
#| echo:true
...
# Save it
write_csv(necofs_month_summ, here::here("data/gom3_monthly_test.csv"))
```




### NECOFS Hourly Product Processing
