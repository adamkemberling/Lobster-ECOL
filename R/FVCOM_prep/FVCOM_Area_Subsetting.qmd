...
So where are we at: \* Need to write some code that can open a connection for an area we care about\* grab 1-4 variables at the surface, and the ones at the bottom\* \* average for the month\* \* and spit them out in a table\*
...
#### Dealing with Date/Sigmas Manually
