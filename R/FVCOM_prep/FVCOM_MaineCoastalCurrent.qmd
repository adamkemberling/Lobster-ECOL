...
# # B. For using the current variable Matt used
# ua and va are vertically averaged x and y velocities
# pca_mat <- monthly_currents %>% 
...
mcc_corrs %>% 
  ...
  labs(
    title = "Reviewing MCC principal component analysis correlations",
