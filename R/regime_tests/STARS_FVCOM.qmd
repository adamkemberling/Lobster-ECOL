...
As expected, ocean temperatures in Southern Mass. follow a prnonounced seasonal cycle. We can model this periodicity to get a sense of the average temperature based on the day of the year.
...
p1 <- ggplot(tester, aes(x = yday)) +
  ...
  labs(color = "Data",
       ...
       x = "Day of Year",
       title = str_c(test_area, " Daily Seasonality"))
...
p2 <- tester  %>% 
  ...
  labs(color = "Data",
       y = "Bottom Temperature",
       x = "Day of Year",
       title = str_c(test_area, " Monthly Seasonality"))
...
tester %>% 
  ...
  labs(
    ...
    title = "Removal of Long-Term Monthly Mean")
```
