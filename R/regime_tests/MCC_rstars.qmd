...
# Project path
fvcom_processed_path <- cs_path(
  "mills", "Projects/Lobster ECOL/FVCOM_processed/MaineCoastalCurrent")
...
# I prepared the same data for a larger area here:
...
# Here is a timeseries of the principal components of that data
# after conversion to monthly and a PCA
...
```{r}
#| label: FVCOM-mesh-expanded area


# Expanded Area Coordinates
...
yr_round_map <- average_directions %>% 
  ...
  labs(
    title = "Average Annual Surface Current Flow for Coastal Maine",
