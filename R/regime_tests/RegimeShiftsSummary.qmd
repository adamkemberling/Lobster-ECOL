...
# Load inshore areas
# 12nm from shore, aggregates of statistical zones
inshore_areas <- map_dfr(
  setNames(
...
Based on these results, we see no breakpoints in primary production or the cold pool indices.
...
### EPU/Offshore Temperature and Salinity
