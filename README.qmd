...
tribble(
  ~"Area",     ~"Metric",         ~"Measurement Frequency",   ~"Data Source", 
  ...
  "Shelf-Scale", "Gulf Stream Position Index",   "Annual or Monthly","ecodata::gsi",
  "Shelf-Scale", "Northeast Channel Water Mass", "Annual",           "ecodata::slopewater") %>% 
  left_join(
    tibble(
      `Area` = c("Nearshore", "Offshore", "Shelf-Scale"),
      `Scale` = c("0-3 Nautical miles", "3-12 Nautical miles", "12+ Nautical miles"))) %>% 
  unite(col = "Spatial Scale", Area, Scale, sep = ": ") %>% 
...
[Exploring Monthly File Contents and Structures](https://adamkemberling.github.io/Lobster-ECOL/R/FVCOM_prep/gmri_inventory_exploration/FVCOM_GMRI-Monthly-Inventory-Check.html)
...
[Maine Coastal Current Processing](https://adamkemberling.github.io/Lobster-ECOL/R/FVCOM_prep/FVCOM_MaineCoastalCurrent_PCA.html)
